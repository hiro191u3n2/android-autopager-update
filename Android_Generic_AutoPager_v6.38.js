...
(() => {
  ...
  const STYLE_ID = "generic-sumahodigest-home-prehide-style-v638";
  const CSS = [
    "body.home.front-top-page #list-wrap .list-new-entries > .list-more-button-wrap",
    "body.home.front-top-page #list-wrap > #list-columns",
    "body.home.front-top-page #list-wrap #list-columns"
  ].join(",") + "{display:none!important;visibility:hidden!important;height:0!important;min-height:0!important;max-height:0!important;margin:0!important;padding:0!important;border:0!important;overflow:hidden!important;}";
