...
// @version      6.34.0
// @description  汎用オートページャー。固定URLからの直接更新に対応。Google追加ページ内の全商品カードを価格要素から特定し、実ページ配色の隔離レイアウトと検索結果区切りで重なり・色ずれ・連結表示を防止。「他の人はこちらも検索」非表示、YouTube原題復元・複数画像対策、PimEyes全画面日本語化・Android画像選択のフォーカス不具合修正、Yahooニュース全文表示・一覧限定UA・記事動画のEdge互換UAと公式プレイヤー準備までの前面サムネ表示・ニュース一覧先行描画と初期監視軽量化・初回一括整理による高速表示・可変案内枠非表示・記事一覧の画像拡大崩れ防止・リアルタイム検索上部キャンペーン枠非表示、スマホダイジェストの末尾関連カテゴリ・「もっと見る」非表示とBuzzap専用の解析完了待機・定期監視・3経路取得・継続再試行対応。
...
(()=>{"use strict";/* generic-pimeyes-ja-upload-v633 */(function pimEyesJapaneseUploadV633Runtime() {
  if (window.top !== window.self) return;
  if (!/(^|\.)pimeyes\.com$/i.test(location.hostname)) return;

  const instanceKey = "__androidGenericPimEyesJapaneseUploadV633";
  if (window[instanceKey]) return;
  window[instanceKey] = true;

  const translations = new Map([
    ["PimEyes: Face Recognition Search Engine and Reverse Image Search", "PimEyes：顔認識・画像検索"],
    ["Home", "ホーム"],
    ["Pricing", "料金"],
    ["About Us", "PimEyesについて"],
    ["Privacy & Ethics", "プライバシーと倫理"],
    ["Opt-Out", "オプトアウト"],
    ["Blog", "ブログ"],
    ["Register", "新規登録"],
    ["Log in", "ログイン"],
    ...
    ["Solutions", "ソリューション"],
    ["Resources", "リソース"],
    ["Legal & Company", "法務・会社情報"],
    ["For Professionals", "専門家向け"],
    ["For Creators", "クリエイター向け"],
    ["For Everyday Users", "一般ユーザー向け"],
    ["For Public Figures", "著名人向け"],
    ["Tutorials", "使い方"],
    ["Support", "サポート"],
    ["FAQ", "よくある質問"],
    ...
    ["World's Best Face Search Engine", "世界最高峰の顔検索エンジン"],
    ["Face Search And Reverse Image Search Engine", "顔検索・画像逆検索エンジン"],
    [
      "Discover where your images appear online, track reuse, and safeguard your privacy.",
      "画像が掲載されている場所を見つけ、転載を追跡し、プライバシーを守ります。",
    ],
    ["Start Search", "検索を開始"],
    ["By performing search, you agree to the", "検索を実行すると、"],
    ["and", "および"],
    ["Upload Your Photo", "写真をアップロード"],
    ["Upload your photo", "写真をアップロード"],
    ["Use Camera", "カメラを使う"],
    ["Results in less than 5 seconds", "最短5秒で結果表示"],
    ["Drop your photo here or Click to browse", "写真をここにドロップ、またはタップして選択"],
    ["Take a photo or Click to browse", "写真を撮る、またはタップして選択"],
    ["Supports photos up to 15 MB", "最大15MBの写真に対応"],
    ["Maximum 5 photos", "最大5枚"],
    [
      "Your photos are processed securely and never stored without your permission",
      "写真は安全に処理され、許可なく保存されません。",
    ],
    ["Face Search", "顔検索"],
    ["Trusted Privacy:", "安心のプライバシー保護："],
    ["GDPR Compliant", "GDPR準拠"],
    ["SSL Encrypted", "SSL暗号化"],
    ["99.5% Search Accuracy", "検索精度99.5%"],
    ["Find Your Face Across The Open Web", "公開ウェブ全体からあなたの顔を検索"],
    [
      "Discover the true scale of your digital footprint. PimEyes leverages advanced face recognition technology to help you monitor your images, protect your privacy, and audit copyright usage across the entire internet.",
      "自分のデジタル上の足跡を確認できます。PimEyesは高度な顔認識技術を使い、画像の掲載状況の確認、プライバシー保護、著作権利用の調査を支援します。",
    ],
    ["How PimEyes Works", "PimEyesの仕組み"],
    ["Four simple steps to discover and protect your online presence", "オンライン上の存在を見つけて守る4つの簡単なステップ"],
    [
      "PimEyes is an online face search engine available for everyone. Start by uploading a clear photo to perform a reverse image search and find pictures containing given faces across the Internet.",
      "PimEyesは誰でも使えるオンライン顔検索エンジンです。顔がはっきり写った写真をアップロードすると、同じ顔が含まれる画像をインターネット上から検索します。",
    ],
    ["AI-Powered Face Search", "AIによる顔検索"],
    [
      "Our advanced face search technologies go through the web in seconds. This facial search online system allows you to search by image and identify every instance where your face appears.",
      "高度な顔検索技術がウェブを短時間で調査し、画像を使って自分の顔が掲載されている場所を探します。",
    ],
    ["Review Results", "検索結果を確認"],
    [
      "Access a comprehensive face picture search report. Find a face and check exactly where the image appears online with detailed source information for every match found.",
      "顔画像の検索結果を一覧で確認できます。一致した画像ごとに、掲載元の詳しい情報を確認できます。",
    ],
    ["Monitor & Protect", "監視して保護"],
    [
      "Our face finder helps you protect your privacy. It is a great tool to audit copyright infringement, set up alerts for new appearances, and take control of your digital identity.",
      "顔検索でプライバシーを守り、無断転載の確認、新しい掲載の通知設定、デジタル上の本人情報の管理ができます。",
    ],
    ["Powerful Features For Complete Protection", "万全の保護を実現する強力な機能"],
    ["Everything you need to discover, monitor, and protect your digital image presence", "ネット上の画像を発見・監視・保護するための機能を備えています"],
    ["Advanced Face Search", "高精度な顔検索"],
    ["Search billions of images across the web with industry-leading facial recognition accuracy", "高精度な顔認識でウェブ上の数十億枚の画像を検索"],
    ["Search across 10+ billion images", "100億枚以上の画像を検索"],
    ["99.5% accuracy rate", "精度99.5%"],
    ["Results in under 5 seconds", "5秒以内に結果表示"],
    ["Advanced Filtering options", "高度な絞り込み"],
    ["Real-Time Monitoring", "リアルタイム監視"],
    ["Get instant alerts when your image appears in new locations online", "自分の画像が新しい場所に掲載されたらすぐに通知"],
    [
      "Set up monitoring for your face and receive instant notifications whenever new matches are detected, so you can act before issues escalate.",
      "自分の顔を監視対象に登録すると、新しい一致画像が見つかった時に通知を受け取り、問題が広がる前に対応できます。",
    ],
    ["Removal Guidance", "削除ガイド"],
    ["Step-by-step assistance to remove unwanted images from websites", "不要な画像をウェブサイトから削除するための手順を案内"],
    [
      "Use PimEyes' built-in tools to identify unauthorized appearances of your image and submit removal requests directly to website owners and search engines.",
      "PimEyesの機能で画像の無断掲載を特定し、サイト運営者や検索エンジンへ削除を依頼できます。",
    ],
    ["Privacy First", "プライバシー最優先"],
    ["Bank-level encryption and GDPR compliance ensure your data stays secure", "強固な暗号化とGDPR準拠でデータを保護"],
    [
      "Your uploaded images are never stored, never shared, and never used to train models. All searches are encrypted end-to-end and discarded after results are returned.",
      "アップロード画像は保存・共有・AI学習に使用されません。検索は暗号化され、結果の返却後に破棄されます。",
    ],
    ["Solutions For Every Identity Challenge", "あらゆる画像・本人確認ニーズに対応"],
    [
      "From individual privacy to corporate security, PimEyes provides advanced facial recognition tools tailored for every stage of your digital journey.",
      "個人のプライバシー保護から企業のセキュリティまで、目的に応じた高度な顔認識機能を提供します。",
    ],
    ["For creators & influencers", "クリエイター・インフルエンサー向け"],
    ["For Creators & Influencers", "クリエイター・インフルエンサー向け"],
    ["Protect your visual copyright with AI", "AIで画像の著作権を保護"],
    [
      "Instantly detect unauthorized use of your photography or digital designs. PimEyes’ reverse image search technology monitors the open web to help you take back control of your intellectual property.",
      "写真やデザインの無断使用を素早く発見します。PimEyesの画像検索が公開ウェブを監視し、知的財産の管理を支援します。",
    ],
    ["Master your digital footprint", "自分のデジタル上の足跡を把握"],
    ["Master Your Digital Footprint", "自分のデジタル上の足跡を把握"],
    [
      "See where your images appear online. Use our facial recognition technology to protect your personal privacy and prevent identity theft across the global web.",
      "自分の画像が掲載されている場所を確認し、顔認識技術でプライバシーを守って、なりすましを防ぎます。",
    ],
    ["For Public Figures & PR", "著名人・広報向け"],
    ["Elite reputation management", "高度な評判管理"],
    ["Stay ahead of the narrative. Use our real-time alerts to detect new appearances of your image online and manage your public profile before a crisis emerges", "リアルタイム通知で新しい画像掲載を早期に発見し、問題が起きる前に公開イメージを管理できます。"],
    ["For Legal & Security Professionals", "法務・セキュリティ専門家向け"],
    ["Advanced investigative infrastructure", "高度な調査基盤"],
    [
      "Enterprise-grade reverse image search designed for lawyers, private investigators, and security teams requiring high-volume data auditing and precise discovery.",
      "大量データの調査と高精度な発見を必要とする弁護士、調査員、セキュリティ部門向けの業務用画像検索です。",
    ],
    ["Learn more", "詳しく見る"],
    ["Choose The Right PimEyes Subscription", "最適なPimEyesプランを選択"],
    [
      "Select a PimEyes pricing plan tailored to your privacy needs. Join millions of users utilizing our advanced facial search engine to monitor their digital identity and protect image rights online",
      "用途に合った料金プランを選べます。高度な顔検索で、ネット上の本人画像を監視し、画像の権利を守れます。",
    ],
    ["Monthly", "月払い"],
    ["Yearly", "年払い"],
    ["The entry point for individual facial search", "個人向け顔検索の基本プラン"],
    ["Get Started", "始める"],
    ["Unlock up to 75 searches daily", "1日最大75回検索"],
    ["Unlock up to 10 PimEyes Alerts", "PimEyes通知を最大10件"],
    ["No CAPTCHA verification", "CAPTCHA認証なし"],
    ["Blur-free images", "ぼかしなしの画像"],
    ["Learn more about all features", "全機能を見る"],
    ["MOST POPULAR", "一番人気"],
    ["Professional monitoring & automated defense", "専門的な監視と自動保護"],
    ["Unlock up to 125 searches daily", "1日最大125回検索"],
    ["Unlock up to 20 PimEyes Alerts", "PimEyes通知を最大20件"],
    ["AI-generated reports", "AI生成レポート"],
    ["Result Management", "検索結果の管理"],
    ["Optional: Takedown Agent Support", "オプション：削除代行サポート"],
    ["Add for ? / month", "月額追加料金で利用"],
    ["Advanced", "アドバンスド"],
    ["The ultimate search engine for high-volume research", "大量調査向けの最上位検索プラン"],
    ["Unlimited daily searches", "1日の検索回数は無制限"],
    ["500 active PimEyes Alerts", "有効なPimEyes通知500件"],
    ["More than PROtect", "PROtect以上の機能"],
    ["Full Deep Search access", "Deep Searchをすべて利用可能"],
    ["Trusted By Millions To Secure Digital Identities", "世界中で利用されるデジタル本人保護サービス"],
    ["daily index updates", "毎日のインデックス更新"],
    ["users worldwide", "世界中のユーザー"],
    ["search accuracy", "検索精度"],
    ["What is a reverse image search?", "画像逆検索とは？"],
    [
      ...
      "画像逆検索は、文字ではなく写真を使って物、人、ブランドなどを探す方法です。通常の検索では言葉に関連するサイトが表示されますが、画像逆検索では似た写真、同一画像の別サイズ、転載先などを確認できます。",
    ],
    ["How to reverse image search?", "画像逆検索の使い方"],
    [
      ...
      "画像逆検索を行うには、検索サービスへ写真をアップロードするか、カメラで撮影します。画像のサイズ、品質、形式、写り方などの条件に注意してください。高品質な画像ほど精度が上がり、スマートフォンからも利用できます。",
    ],
    ["More than a reverse image search", "画像逆検索を超えた顔検索"],
    [
      "PimEyes uses a reverse image search mechanism and enhances it by face recognition technology to allow you to find your face on the Internet (but only the open web, excluding social media and video platforms). Like in a reverse image search you perform a query using a photo and you receive the list of indexed photos in the results. But PimEyes is more than that. In the results we display not only similar photos to the one you have uploaded to the search bar but also pictures in which you appear on a different background, with other people, or even with a different haircut. This improvement is possible thanks to our search engine focusing on a given face, not the whole picture. Try PimEyes’ reverse image search engine and find where your face appears online.",
      "PimEyesは画像逆検索に顔認識を組み合わせ、公開ウェブ上から自分の顔を探します。SNSや動画サービスは対象外です。画像全体ではなく顔を中心に照合するため、背景、同席者、髪型が異なる写真も見つけられます。",
    ],
    ["Latest from our Blog", "ブログ最新記事"],
    ["Your path to privacy starts with knowledge", "プライバシー保護は知ることから始まります"],
    ["DEFAULT", "記事"],
    ["For Legal & Security Professionals - Advanced Investigative Infrastructure", "法務・セキュリティ専門家向け―高度な調査基盤"],
    [
      "Precision discovery for professional investigations Legal and security work runs on evidence, and increasingly that evidence is visual. Verifying an identity, tracing the origin of an image, connecting a photo to a person or place, uncovering fraud, or auditing a large volume of visual material - these are core tasks for lawyers, private investigators, and corporate security teams. PimEyes provides the infrastructure to do them at scale and with precision.",
      "専門調査には正確な発見が必要です。法務やセキュリティでは画像が重要な証拠となり、本人確認、画像の出所調査、人や場所との関連付け、不正の発見、大量画像の監査が求められます。PimEyesは、これらを大規模かつ高精度に行うための基盤を提供します。",
    ],
    ["Elite Reputation Management For Public Figures & PR", "著名人・広報向けの高度な評判管理"],
    [
      "In reputation, timing is everything For a public figure, an image can define a moment before a single word is spoken. A photo taken out of context, a manipulated image, an unauthorised endorsement, or a fabricated deepfake can travel across the web in hours. The difference between a manageable situation and a full-blown crisis is almost always how early you knew. The traditional problem for public figures and their PR teams is that they find out last. By the time a damaging image reaches a client's inbox, it has usually already spread. Elite reputation management inverts that - it's about seeing new appearances of a client's image as they emerge, so the response can begin before the narrative sets.",
      "評判管理では早さが重要です。文脈を外れた写真、加工画像、無断広告、偽のディープフェイクは数時間で拡散します。著名人や広報担当者が新しい画像掲載を早期に把握できれば、問題が広がる前に対応できます。",
    ],
    [
      "You have a digital footprint. It's bigger than you think. Most of us have spent years online - social profiles, tagged photos from friends, old accounts, event pages, forum posts, and images we don't even remember uploading. Every one of those leaves a trace. The result is a \"digital footprint\": the collection of images and information about you scattered across the public web, much of which you never put there yourself and can't easily see. The uncomfortable truth is that this footprint is far more visible to strangers than it is to you. Anyone can search; you're the only one who assumes it's all under control. PimEyes exists to flip that around - to let you see what's out there, so you can decide what to do about it.",
      "私たちのデジタル上の足跡は想像以上に広がっています。SNS、友人がタグ付けした写真、古いアカウント、イベントページ、掲示板への投稿などが公開ウェブ上に残ります。PimEyesを使うと、自分に関する画像がどこにあるかを確認し、どう対応するか判断できます。",
    ],
    [
      ...
      "写真、デザイン、動画、個人ブランドを仕事にする人にとって、画像は大切な資産です。しかし公開後の画像は、スクリーンショット、転載、切り抜き、透かしの追加などで無断利用されることがあります。PimEyesは作品が公開ウェブのどこに掲載されているかを示し、早期対応を支援します。",
    ],
    ["What PimEyes Can (and Can’t) See", "PimEyesで見つけられるもの・見つけられないもの"],
    [
      "by Sophia - your AI guide through the digital world. Have you ever wondered what PimEyes can actually “see”? It’s a fair question - especially in a world where AI, privacy, and personal data often seem tangled together. As PimEyes’ AI guide, I’m here to explain - clearly and calmly - what this technology truly does, and what it doesn’t. Because when it comes to online visibility, understanding the limits is just as important as knowing the possibilities.",
      "デジタル世界を案内するAIのSophiaが、PimEyesで実際に確認できるものとできないものを分かりやすく説明します。オンライン上の公開範囲を理解するには、技術の可能性だけでなく限界を知ることも大切です。",
    ],
    ["Have You Been Turned Into a Meme Without Knowing?", "知らないうちに自分がミームになっていませんか？"],
    [
      "Imagine scrolling through your feed, laughing at memes—then suddenly you stop. Is that you? Being turned into a meme without your consent happens more often than you think. In today’s digital world, your face can go viral in seconds. Here’s how it happens—and how PimEyes can help you protect your image online.",
      "フィードを見ていて、突然自分の顔を使ったミームを見つけることがあります。許可なくミーム化されることは珍しくありません。画像が拡散する仕組みと、PimEyesで自分の画像を守る方法を紹介します。",
    ],
    ["Response from PimEyes to U.S. Senate Remarks: How Open-Web Image Search Protects Privacy and Transparency", "米国上院の発言に対するPimEyesの見解―公開ウェブ画像検索とプライバシー・透明性"],
    [
      "Recently, Biometric Update mentioned PimEyes in a discussion about privacy, law enforcement, and transparency around image-search technologies. This conversation offers an important opportunity to clarify what PimEyes is - and how it’s designed to support safety, privacy, and compliance with the world’s strictest data standards.",
      "画像検索技術をめぐるプライバシー、法執行、透明性の議論を受け、PimEyesの仕組みと、安全性・プライバシー・厳格なデータ基準への対応方針を説明します。",
    ],
    ["How to Spot Catfishing: Red Flags, Risks & Protection with PimEyes", "なりすましを見抜く方法―危険な兆候とPimEyesによる保護"],
    [
      "Not everyone online is who they claim to be. All it takes is one perfect selfie and a few sweet texts to fool someone. But what if your “soulmate” is actually Larry from Ohio with a WiFi router collection? From romance scams to stolen photos, catfishing is a growing online threat. The good news? You can spot the signs early—and with tools like PimEyes, protect yourself and your identity.",
      "ネット上の相手が名乗っている本人とは限りません。恋愛詐欺や盗用画像を使ったなりすましは増えています。危険な兆候を早く見抜き、PimEyesなどの機能で自分と本人情報を守る方法を紹介します。",
    ],
    ["How PimEyes Alert Helps You Stay In Control Of Your Privacy", "PimEyes通知でプライバシーを管理する方法"],
    [
      "Your face is your identity — don’t let anyone use it without your consent. PimEyes Alert gives you real-time notifications when your photos appear online, helping you protect your image, reputation, and privacy.",
      "顔は本人を示す大切な情報です。PimEyes通知は自分の写真がネット上に現れた時に知らせ、画像、評判、プライバシーの保護を支援します。",
    ],
    ["Read more", "続きを読む"],
    ["Start Your Privacy Journey Today", "今日からプライバシー保護を始めましょう"],
    ["Ready To Take Control Of Your Digital Image", "自分のデジタル画像を管理する準備はできましたか"],
    ["Join 500,000+ users who trust PimEyes to protect their online privacy.", "50万人以上がPimEyesでオンライン上のプライバシーを守っています。"],
    ["Start with a free search and see where your images appear online", "まずは無料検索で、自分の画像がどこに掲載されているか確認できます"],
    ["Start free search now", "今すぐ無料検索を開始"],
    ["Learn about PimEyes", "PimEyesについて知る"],
    [
      "PimEyes is a privacy-first online face search engine and reverse image search technology. We empower individuals to monitor their online presence, protect their digital identity, and audit copyright infringement with advanced facial search solutions.",
      "PimEyesはプライバシーを重視したオンライン顔検索・画像逆検索サービスです。高度な顔検索で、ネット上の本人画像の監視、デジタル上の本人情報の保護、著作権侵害の確認を支援します。",
    ],
    ["Consent", "同意"],
    ["Details", "詳細"],
    ["Ad Settings", "広告設定"],
    ["About", "概要"],
    ["Responsible use of your data", "データの適切な利用"],
    ["We and", "当社と"],
    [
      "process your personal data, e.g. your IP-number, using technology such as cookies to store and access information on your device in order to serve personalized ads and content, ad and content measurement, audience research and services development. You have a choice in who uses your data and for what purposes. Your privacy choices are only applicable on this digital property where you have made your choices. You can change or withdraw your consent any time from the Cookie Declaration or by clicking on the Privacy trigger icon.",
      "は、IPアドレスなどの個人データを処理し、Cookie等を使って端末情報を保存・参照します。目的は広告・コンテンツの提供と測定、利用状況の調査、サービス改善です。データの利用者と利用目的を選択でき、Cookie宣言またはプライバシー設定からいつでも同意を変更・撤回できます。",
    ],
    ["If you allow, we would also like to:", "許可した場合、次の情報も利用します："],
    ["Collect information about your geographical location which can be accurate to within several meters", "数メートル単位までの正確な位置情報を取得"],
    ["Identify your device by actively scanning it for specific characteristics (fingerprinting)", "端末固有の特徴を調べて端末を識別（フィンガープリント）"],
    ["Find out more about how your personal data is processed and set your preferences in the", "個人データの処理方法を確認し、利用設定を変更するには"],
    ["details section", "詳細設定"],
    [
      "We use cookies to personalise content and ads, to provide social media features and to analyse our traffic. We also share information about your use of our site with our social media, advertising and analytics partners who may combine it with other information that you’ve provided to them or that they’ve collected from your use of their services.",
      "当サイトは、コンテンツや広告の最適化、SNS機能の提供、アクセス解析のためにCookieを使用します。サイトの利用情報はSNS・広告・解析の提携先と共有され、他の提供情報や各社サービスの利用情報と組み合わせられる場合があります。",
    ],
    ["Consent Selection", "同意項目の選択"],
    ["Necessary", "必須"],
    ["Preferences", "設定"],
    ["Statistics", "統計"],
    ["Marketing", "マーケティング"],
    ...
    ["Accept all", "すべて同意"],
    ["Deny", "拒否"],
    ["Allow selection", "選択した項目を許可"],
    ["Allow all", "すべて許可"],
    ["Maximum Storage Duration", "最長保存期間"],
    ["Type", "種類"],
    ["Pending", "確認中"],
    ["Privacy policy:", "プライバシーポリシー："],
    ["Legitimate Interest:", "正当な利益："],
    ["About Ad Settings", "広告設定について"],
    ["View our list of partners", "パートナー一覧を見る"],
    ["Do not sell or share my personal information", "個人情報を販売・共有しない"],
    ["Upload file", "画像を選択"],
    ["Take your picture", "写真を撮影"],
    ["PimEyes home", "PimEyesホーム"],
    ["Toggle navigation menu", "メニューを開閉"],
    ["Previous slide", "前のスライド"],
    ["Next slide", "次のスライド"],
    ["Toggle PROtect Agent Support add-on", "PROtect削除代行オプションを切り替え"],
    ["Takedown Agent Support", "削除代行サポート"],
    ["Search", "検索"],
    ["Searching...", "検索中…"],
    ["Loading...", "読み込み中…"],
    ["Continue", "続ける"],
    ...
    ["Try again", "もう一度試す"],
    ["Select face", "顔を選択"],
    ["Please select a face", "検索する顔を選択してください"],
    ["No face detected", "顔を検出できませんでした"],
    ["Something went wrong", "エラーが発生しました"],
    ["Image is too large", "画像サイズが大きすぎます"],
    ["Unsupported file type", "対応していない画像形式です"],
    ["Phone showing PimEyes face search results", "PimEyesの顔検索結果を表示したスマートフォン"],
    ["Demonstration of a PimEyes face search", "PimEyes顔検索のデモ"],
    ["Facial recognition scan mapping a woman's face", "顔を解析する顔認識スキャン"],
    ["Face search result showing a matched photo of a creator reused on another website", "別サイトで再利用されたクリエイター画像の一致結果"],
    ["Investigator reviewing photos of a face found across websites", "複数サイトで見つかった顔写真を確認する調査員"],
    ["„It's quick, it's accurate, it's facial recognition on steroids”", "「速くて正確。非常に強力な顔認識です」"],
    ["„PimEyes, a search engine that’s handy for reverse image searching and facial recognition”", "「画像逆検索と顔認識に役立つ検索エンジン、PimEyes」"],
    ["„The facial recognition site PimEyes is one of the most capable face-searching tools on the planet”", "「PimEyesは世界でも特に高性能な顔検索ツールの一つです」"],
    ["„For $29.99 a month PimEyes offers a potentially dangerous superpower from the world of science fiction”", "「月額29.99ドルで、SFのように強力な能力を提供します」"],
    ["BBC logo", "BBCロゴ"],
    ["Vice logo", "Viceロゴ"],
    ["The Washington Post logo", "ワシントン・ポストのロゴ"],
    ["New York Times logo", "ニューヨーク・タイムズのロゴ"],
    ["PimEyes on Instagram", "InstagramのPimEyes"],
    ["PimEyes on Facebook", "FacebookのPimEyes"],
    ["PimEyes on TikTok", "TikTokのPimEyes"],
    ["PimEyes on X", "XのPimEyes"],
    ["PimEyes on YouTube", "YouTubeのPimEyes"],
    ["PimEyes on LinkedIn", "LinkedInのPimEyes"],
    ["Cookiebot by Usercentrics - opens in a new window", "UsercentricsのCookiebot（新しいウィンドウで開く）"],
    ["Privacy policy - opens in a new window", "プライバシーポリシー（新しいウィンドウで開く）"],
    ["Legitimate Interest - opens in a new window", "正当な利益（新しいウィンドウで開く）"],
    ["opens in a new window", "新しいウィンドウで開く"],
    ["Expand", "展開"],
  ]);

  const attributeNames = ["aria-label", "title", "placeholder", "alt"];
  const excludedSelector =
    "script,style,noscript,template,textarea,pre,code,[contenteditable='true']";
  ...
  function translateDynamic(value) {
    let match = value.match(/^our\s+(\d+)\s+partners$/i);
    if (match) return `提携先${match[1]}社`;
    match = value.match(/^(Necessary|Preferences|Statistics|Marketing|Unclassified|Purposes|Features|Partners)\s+\((\d+)\)$/i);
    if (match) return `${translations.get(match[1]) || match[1]}（${match[2]}件）`;
    match = value.match(/^You have\s+(\d+)\s+of\s+(\d+)\s+searches left today\.$/i);
    if (match) return `本日の検索残り回数：${match[1]}/${match[2]}回`;
    if (/^We and our \d+ partners process your personal data,/i.test(value)) {
      return "当社と提携先は、Cookieなどの技術を使って端末情報を保存・参照し、広告やコンテンツの提供・測定、利用状況の調査、サービス改善のために個人データを処理します。利用目的や利用者を選択でき、同意内容はいつでも変更できます。";
    }
    return value;
  }
  ...
  function translated(value) {
    ...
    if (!key) return key;
    return translations.get(key) || translateDynamic(key);
  }
  ...
  function isExcluded(element) {
    ...
    try {
      ...
      return /^(SCRIPT|STYLE|NOSCRIPT|TEMPLATE|TEXTAREA|PRE|CODE)$/i.test(
        element.tagName || "",
      );
    }
  }
  ...
  function translateAttributes(element) {
    ...
    for (const name of attributeNames) {
      ...
      if (!source) continue;
      const replacement = translated(source);
      if (replacement && replacement !== normalize(source)) {
  ...
  function dropzoneForSurface(surface) {
    let current = surface?.parentElement || null;
    for (let depth = 0; current && depth < 7; depth += 1, current = current.parentElement) {
      const input = Array.from(current.children || []).find((child) =>
        child.matches?.(
          'input[type="file"][multiple][accept*="image"]:not([capture])',
        ),
      );
      if (input) return { input, root: current };
    }
    return null;
  }

  function surfaceFromPath(event) {
    const path = typeof event.composedPath === "function" ? event.composedPath() : [];
    for (const node of path) {
      if (!node || node.nodeType !== 1) continue;
      if (!node.matches?.('input[type="text"][inputmode="none"]')) continue;
      if (dropzoneForSurface(node)) return node;
    }
    return null;
  }

  function activeConsentDialog() {
    ...
    try {
      ...
      return dialog.classList?.contains("CybotCookiebotDialogActive") || false;
    }
  }

  function onTouchStart(event) {
    touchGesture = null;
    if (!event.isTrusted || event.touches?.length !== 1 || activeConsentDialog()) return;
    const surface = surfaceFromPath(event);
    const dropzone = dropzoneForSurface(surface);
    if (!surface || !dropzone || dropzone.input.disabled) return;
  ...
  function onTouchEnd(event) {
    ...
    touchGesture = null;
    if (!gesture || !event.isTrusted || !event.cancelable || event.touches?.length) return;
    ...
    if (distance > 12 || Date.now() - gesture.startedAt > 900) return;
    if (
      !gesture.surface.isConnected ||
      !gesture.input.isConnected ||
      gesture.input.disabled ||
      gesture.input.getAttribute?.("aria-disabled") === "true" ||
      gesture.input.closest?.('[aria-busy="true"],[data-loading="true"]') ||
      document.activeElement !== gesture.surface
    ) {
      return;
    }
    try {
      gesture.surface.blur();
      gesture.surface.dataset.genericPimEyesUploadFocusV633 = "repaired";
    } catch {}
  }
...
})();/* generic-yahoo-article-edge-ua-v632 */(function yahooArticleUaV632Runtime() {
  if (window.top !== window.self) return;
...
(() => {
  ...
  const hide = (el, reason = '') => {
    ...
    if (el.matches('main,[role="main"],#main,#content,#primary')) return;
    el.classList.add(HIDDEN);
    el.setAttribute('aria-hidden', 'true');
    if (reason) el.dataset.genericSumahoDigestHiddenV634 = reason;
  };

  const isCategoryHeading = (el) => {
    if (!(el instanceof HTMLElement)) return false;
    const c = compact(el.textContent || '');
    if (!c || c.length > 40) return false;
    for (const label of CATEGORY_LABELS) {
      if (c === compact(label)) return true;
    }
    return false;
  };

  const findCategorySection = (heading) => {
    let node = heading;
    const candidates = [];
    ...
    for (let depth = 0; node && depth < 8; depth += 1, node = node.parentElement) {
      ...
      if (node.matches('main,[role="main"],#main,#content,#primary')) continue;
      if (node.closest('.generic-autopager-divider,.generic-autopager-page')) continue;

      const rect = node.getBoundingClientRect();
      const height = Math.max(rect.height, node.scrollHeight || 0);
      const width = Math.max(rect.width, node.scrollWidth || 0);
      if (width < 180 || height < 90 || height > 2600) continue;

      const links = node.querySelectorAll('a[href]').length;
      const images = node.querySelectorAll('img,picture').length;
      const more = Array.from(node.querySelectorAll('a,button,[role="button"],[role="link"]'))
        .some(el => /^もっと(?:見る|みる)$/.test(compact(el.textContent)));

      if (links < 3 || links > 40) continue;
      if (images < 2) continue;
      if (!more) continue;

      const area = Math.max(1, width) * Math.max(1, height);
      candidates.push({ node, area, depth });
    }
  ...
  const hideCategoryBlocks = () => {
    const headings = document.querySelectorAll(
      'h1,h2,h3,h4,h5,h6,[role="heading"],.widget-title,.section-title,.heading-title,div,span'
    );

    for (const heading of headings) {
      if (!(heading instanceof HTMLElement)) continue;
      if (!isCategoryHeading(heading)) continue;
      if (heading.closest(\`.\${HIDDEN}\`)) continue;
      const section = findCategorySection(heading);
      if (section) hide(section, \`category:\${compact(heading.textContent)}\`);
    }
  };

  const hideStandaloneMoreButtons = () => {
    for (const control of document.querySelectorAll('a,button,[role="button"],[role="link"]')) {
      if (!(control instanceof HTMLElement)) continue;
      if (!/^もっと(?:見る|みる)$/.test(compact(control.textContent))) continue;
      if (control.closest(\`.\${HIDDEN}\`)) continue;
      if (control.closest('.generic-autopager-divider,.generic-autopager-page')) continue;

      let row = control.closest('p,li,nav,div,section') || control;
      let best = null;
      for (let depth = 0; row && depth < 4; depth += 1, row = row.parentElement) {
        if (!(row instanceof HTMLElement)) continue;
        if (row === document.body || row === document.documentElement) break;
        if (row.matches('main,[role="main"],#main,#content,#primary')) continue;
        const rect = row.getBoundingClientRect();
        const height = Math.max(rect.height, row.scrollHeight || 0);
        const links = row.querySelectorAll('a[href]').length;
        const images = row.querySelectorAll('img,picture').length;
        if (height <= 170 && links <= 3 && images === 0) {
          best = row;
          break;
        }
      }
      hide(best || control, 'standalone-more');
    }
  };

  const hideNativePagination = () => {
    const selectors = [
      '.pagination', 'nav.pagination', '.pager', '.paging', '.page-navi', '.pagenation',
      'ul.page-numbers', '.page-numbers', '[class*="pagination" i]', '[id*="pagination" i]',
      'nav[aria-label*="pagination" i]', 'nav[aria-label*="ページ"]'
    ].join(',');

    for (const el of document.querySelectorAll(selectors)) {
      if (!(el instanceof HTMLElement)) continue;
      if (el.closest('.generic-autopager-divider,.generic-autopager-page')) continue;
      hide(el, 'native-pagination');
    }
  };
  ...
  const startObserver = () => {
    ...
    if (!target) return window.requestAnimationFrame(startObserver);
    const observer = new MutationObserver(schedule);
